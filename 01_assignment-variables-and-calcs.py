...
def exercise03():
    ...
    # ------ Place code below here \/ \/ \/ ------
    sentence = "I'm a programmer now then?  Where's my 6 digit job??"
    # ------ Place code above here /\ /\ /\ ------
...
def exercise16():
    # Implement pythagorean thereom and find the length of hypotenuse c given sides a and b. Select any numbers for a and b. Use math.sqrt() for square root.
